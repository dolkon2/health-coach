...
A personal hub for how you succeed at the things you do — the outdoor sports you play (Earth / Sky / Water) and the Body infrastructure (gym, nutrition, PT, breathwork, mobility) that lets you keep going out to play them. One timeline for training, food, recovery, and outcomes, so inputs can be correlated against results instead of living in separate apps. Built by me, for me — I am the primary user, and that's the strongest starting point, not a limitation.

*Reframed 2026-07-09 — earlier drafts led with "personal health + training hub," which framed the product around body transformation. The actual story is outdoor success: Earth/Sky/Water is where success happens, Body is infrastructure for it. See § The four dimensions for the framework.*
...
5. **No gamification.** No streaks, badges, scores, points, or shareable outcome-competition content (whether that's body change, PRs against strangers, or leaderboard-style ranking). These are incompatible with an honesty-first product. The pressure to add them will be strongest for beginner/onboarding flows — hold the line hardest exactly there. *Amended 2026-07-09: earlier drafts said "shareable body-change content." That framing assumed a body-transformation product this no longer is. What people share is how they show up to what they do outside (Earth/Sky/Water); Body is infrastructure for that, not an identity to compete on. The same "showing up, not outcomes" discipline applies to Profile and Groups.*  
