/**
 * Migration 010 (SKY BRANCH HISTORY — never registered post-merge; see migrations/index.ts). Earth's own 010 lives in 010_gear.ts.
 *
...
export const migration010Sky: Migration = {
  version: 10,
  name: 'gear',
  sql: `
