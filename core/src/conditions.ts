/**
 * conditions.ts — Open-Meteo forecast → frozen ConditionsSnapshot (pure).
 *
...
type Surface = NonNullable<ConditionsSnapshot['surface']>;
type Aloft = NonNullable<ConditionsSnapshot['aloft']>;
...
export function normalizeOpenMeteo(
  ...
  const snapshot: ConditionsSnapshot = { ...meta, source: 'open-meteo' };
